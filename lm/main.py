...
parser.add_argument('--data', type=str, default='./data/a2c/an/',
                    help='location of the data corpus')
parser.add_argument('--model', type=str, default='LSTMCell',
                    help='type of recurrent net (RNN_TANH, RNN_RELU, LSTM, GRU)')
parser.add_argument('--save_dict', type=str, default='dict.an.pkl',
...
parser.add_argument('--save', type=str,  default='a2c_an.pt',
...
corpus = data.Corpus(args.data,args.save_dict)
