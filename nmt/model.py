...
class NMT(nn.Module):
    ...
    def beam(self, src_sents, beam_size=5):
        """
        perform beam search
        """
        if not type(src_sents[0]) == list:
        ...
        while len(completed_hypotheses) < beam_size and t < self.args.decode_max_time_step:
            ...
            try:
                ...
                print("====================")
                print("live_hyp_num:",live_hyp_num)
                print("====================")
                print("top_new_hyp_pos:",top_new_hyp_pos)
                print("====================")
                print("tgt_vocab_size:",tgt_vocab_size)
                print("====================")
                print("prev_hyp_ids:",prev_hyp_ids)
                print("====================")
                print("len(p_t_cpu):",len(p_t_cpu))
                print("====================")
...
def to_input_variable(sents, vocab, cuda=False, is_test=False):
    ...
    做word2id操作并padding，变成pytouch变量
    """
