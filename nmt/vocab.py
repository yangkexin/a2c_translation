...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_src',default = "data/ch/train.txt", type=str, required=True, help='file of source sentences')
    parser.add_argument('--train_tgt',default = "data/an/train.txt", type=str, required=True, help='file of target sentences')

    parser.add_argument('--output', default='vocab_ch_an.bin', type=str, help='output vocabulary file')
